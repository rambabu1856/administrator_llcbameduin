  ...
  <aside class="main-sidebar sidebar-dark-secondary">
    <!-- Brand Logo -->
    <a href="javascript:void(0)" class="brand-link border-1" style="border-bottom-color:darkgrey ">
      <img src="{{ asset('storage/media/web_images/logo.jpg') }}" alt="LLC-Logo" class="brand-image img-circle elevation-2"
        style="opacity: .8" style="min-height: 50px;">
      <span class="brand-text h6">LLC-BAM</span>
    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item"> {{-- menu-open --}}
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{ url('admin/student_admission_register') }}" class="nav-link">
