      ...
      $(document).ready(function() {
        ...
        $(document).on("click", ".btnEditProfile", function(e) {
          ...
          $.get("{{ route('student_profile.index') }}" + '/' + studentId + '/edit', function(data) {
            ...
            $('input[name=txtModalDateOfBirth]').val(moment(data.date_of_birth).format("DD/MM/YYYY"));
          ...
          success: function(response) {
            ...
            $.each(response, function(i, v) {
              ...
              $("#tblStudentProfile tbody").append('<tr>' +
                ...
                .father_name + '</span>' + '<br><span class="text-pink">' + v.mother_name + '</span></td>' +
