                    ...
                    <x-form.form action="" method="POST" name="searchForm">
                        ...
                        <x-card.card-body>
                            ...
                            <div class="row">
                                ...
                                <x-form.select2 grid="col-md-2" lblClass="required" lblText="Select Course"
                                    name="cmbCourse" :options="$course"></x-form.select2>

                                <x-form.select2 grid="col-md-2" lblClass="required" lblText="Select Batch"
                                    name="cmbBatch" :options="[]"></x-form.select2>

                                <x-form.select2 grid="col-md-2" lblClass="" lblText="Select Gender" name="cmbGender"
                                    :options="$gender"></x-form.select2>

                                <x-form.select2 grid="col-md-2" lblClass="" lblText="Select Community"
                                    name="cmbCommunity" :options="$community">
                                </x-form.select2>

                                <x-form.select2 grid="col-md-2" lblClass="" lblText="Is belogs to PwD category"
                                    name="cmbIsPwd" :options="$is_active"></x-form.select2>

                                <x-form.input grid="col-md-2" lblClass="" lblText="Search By Name / Enrl. No"
                                    type="text" name="txtSearchBy" value=""></x-form.input>
                            </div>

                            <div class="input-group">
                                <x-button.button grid="mb-3" type="button" btnClass="bg-primary mr-1"
                                    name="btnSearch" faClass="fa-regular fa-paper-plane mr-2" tooltip="Search"
                                    btnText="GET" dataId=""></x-button.button>

                                <x-button.button grid="mb-3" type="button" btnClass="bg-danger mr-1 resetForm"
                                    name="btnAdmissionDetail" faClass="fa-solid fa-rotate mr-2" tooltip="Reset"
                                    btnText="RESET" dataId="">
                                </x-button.button>
                            </div>
            ...
            <x-form.form action="" method="POST" name="modalEditProfileForm">
                ...
                <x-modal.modal-body>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-3">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <img id="preview" src="{{ asset('storage/media/web_images/student.png') }}"
                                    alt="Student Image" class="img-thumbnail" style="min-height: 220px;" />

                                <label class="btn btn-block btn-success mt-1 text-sm">
                                    <i class="fas fa-cloud-upload-alt mr-2"></i> Browse <input type="file"
                                        name="student_image" id="student_image" hidden>
                                </label>
                            </div>
                        ...
                        <div class="col-sm-12 col-md-9">
                            <div class="row">
                                ...
                                <x-form.select2 grid="col-sm-12 col-md-3" lblClass="required" lblText="Campus"
                                    name="cmbModalCampus" :options="$campus"
                                    selectedOptionVariables="[]"></x-form.select2>
                                ...
                                <x-form.select2 grid="col-sm-12 col-md-3" lblClass="required" lblText="Course"
                                    name="cmbModalCourse" :options="$course"></x-form.select2>

                                <x-form.select2 grid="col-sm-12 col-md-3" lblClass="required" lblText="Batch"
                                    name="cmbModalBatch" :options="$batch"></x-form.select2>

                            </div>

                            <div class="row">

                                <x-form.input grid="col-sm-12 col-md-2" lblClass="required" lblText="Roll Number"
                                    type="text" name="txtModalRollNo"></x-form.input>

                                <x-form.input grid="col-sm-12 col-md-2" lblClass="required" lblText="Admission Year"
                                    type="text" name="txtModalEnrollmentYear"></x-form.input>

                                <x-form.input grid="col-sm-12 col-md-2" lblClass="required"
                                    lblText="Registration Number" type="text"
                                    name="txtModalRegistrationNumber"></x-form.input>

                                <x-form.input grid="col-sm-12 col-md-2" lblClass="required"
                                    lblText="Registration Year" type="text"
                                    name="txtModalRegistrationYear"></x-form.input>

                                <x-form.input grid="col-sm-12 col-md-2" lblClass="" lblText="Exam Roll Number"
                                    type="text" name="txtModalExaminationRollNumber"></x-form.input>

                                <x-form.input grid="col-sm-12 col-md-2" lblClass="" lblText="Exam Regn. Year"
                                    type="text" name="txtModalExaminationRollYear"></x-form.input>

                            </div>

                            <div class="row">

                                <x-form.input grid="col-sm-12 col-md-12" lblClass="required" lblText="Student Name"
                                    type="text" name="txtModalStudentName"></x-form.input>

                            </div>

                            <div class="row">
                                <x-form.input grid="col-sm-12 col-md-4" lblClass="required" lblText="Father Name"
                                    type="text" name="txtModalFatherName"></x-form.input>

                                <x-form.input grid="col-sm-12 col-md-4" lblClass="required" lblText="Mother Name"
                                    type="text" name="txtModalMotherName"></x-form.input>

                                <x-form.input grid="col-sm-12 col-md-4" lblClass="" lblText="Guardian Name"
                                    type="text" name="txtModalGuardianName"></x-form.input>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <x-form.input grid="col-sm-12 col-md-3" lblClass="required" lblText="Fee Receipt Date"
                            type="text" name="txtModalDateOfBirth" value=""></x-form.input>

                        <x-form.select2 grid="col-sm-12 col-md-3" lblClass="required" lblText="Gender"
                            name="cmbModalGender" :options="$gender"></x-form.select2>
                        ...
                        <x-form.select2 grid="col-sm-12 col-md-3" lblClass="required" lblText="Religion"
                            name="cmbModalReligion" :options="$religion"></x-form.select2>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <x-form.select2 grid="col-sm-12 col-md-3" lblClass="required" lblText="Is PwD"
                            name="cmbModalIsPwd" :options="$is_active"></x-form.select2>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="row">
                                ...
                                <x-form.input grid="col-sm-12 col-md-12" type="text" lblClass=""
                                    lblText="Local Addrsss L2" type="text" name="txtModalLocalAddressL2" />
                                ...
                                <x-form.input grid="col-sm-12 col-md-12" type="text" lblClass="required"
                                    lblText="State (Local)" name="txtModalLocalState" />

                                <x-form.input grid="col-sm-12 col-md-12" type="text" lblClass="required"
                                    lblText="Pin (Local)" name="txtModalLocalPin" />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="row">
                                ...
                                <x-form.input grid="col-sm-12 col-md-12" type="text" lblClass="required"
                                    lblText="Permanent Addrsss L1" type="text"
                                    name="txtModalPermanentAddressL1" />

                                <x-form.input grid="col-sm-12 col-md-12" type="text" lblClass=""
                                    lblText="Permanent Addrsss L2" type="text"
                                    name="txtModalPermanentAddressL2" />
                    ...
                    <div class="row">
                        ...
                        <x-form.input grid="col-sm-12 col-md-3" lblClass="required" lblText="Phone Number"
                            type="text" name="txtModalPhoneNumber" minlength="10" maxlength="10"></x-form.input>
